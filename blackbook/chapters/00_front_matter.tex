\begin{titlepage}
    \begin{center}
        ...
        \textbf{SUBMITTED BY} \\
        \vspace{0.5cm}
        Bhavesh Tayade \hspace{2cm} Exam No.: 4062
...
\end{center}
\vspace{1cm}
This is to certify that the project report entitled \textbf{``Salariann: An IT Job Market Platform for Dynamic Suitability Scoring and Discovery''} submitted by \textbf{Bhavesh Tayade} is a bonafide work carried out under the supervision of \textbf{Prof. Priyanka Kakde} and it is approved for the partial fulfillment of the requirement of Savitribai Phule Pune University, for the award of the degree of \textbf{Bachelor of Engineering (Information Technology)}.
